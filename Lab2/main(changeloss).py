...
def train(net_type,activations,train_loader, test_loader, num_epochs=10, learning_rate=0.001, device='cuda'):
...
def predict(net_type,loaded_models,test_loader,device="cuda"):
    ...
    if(net_type == "eeg"):
        ...
        print("The performance of the DeepConvNet model with different activation functions is as follows:")  
