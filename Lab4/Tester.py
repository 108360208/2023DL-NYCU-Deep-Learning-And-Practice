...
def get_key(fp):
    ...
    #return int(filename) 不確定是不是助教用錯
...
if __name__ == '__main__':
    ...
    parser.add_argument('--DR',            type=str, default='C:/Users/Steven/Desktop/課程資料/交大/2023DL/Lab/Lab4/LAB4_Dataset',  help="Your Dataset Path")
